...
public class TFEntities {
	...
	public static final EntityType<ArmoredGiant> ARMORED_GIANT = registerWithEgg("armored_giant", EntityType.Builder.of(ArmoredGiant::new, MobCategory.MONSTER).sized(2.4F, 7.2F).clientTrackingRange(16), ArmoredGiant::registerAttributes, ArmoredGiant::checkGiantSpawnRules);
	...
	public static final EntityType<CharmEffect> CHARM_EFFECT = registerMisc("charm_effect", EntityType.Builder.<CharmEffect>of(CharmEffect::new, MobCategory.MISC).sized(0.0F, 0.0F).clientTrackingRange(4).updateInterval(Integer.MAX_VALUE).noSave().noSummon().fireImmune());
	...
	public static final EntityType<GiantMiner> GIANT_MINER = registerWithEgg("giant_miner", EntityType.Builder.of(GiantMiner::new, MobCategory.MONSTER).sized(2.4F, 7.2F).clientTrackingRange(16), GiantMiner::registerAttributes, GiantMiner::checkGiantSpawnRules);
	...
	public static final EntityType<HedgeSpider> HEDGE_SPIDER = registerWithEgg("hedge_spider", EntityType.Builder.of(HedgeSpider::new, MobCategory.MONSTER).sized(1.4F, 0.9F), HedgeSpider::createAttributes, HedgeSpider::checkSpiderSpawnRules);
	...
	public static final EntityType<IceCrystal> ICE_CRYSTAL = registerWithEgg("ice_crystal", EntityType.Builder.of(IceCrystal::new, MobCategory.MONSTER).sized(0.6F, 1.8F).clientTrackingRange(8), IceCrystal::registerAttributes, Monster::checkMonsterSpawnRules);
	...
	public static final EntityType<MazeSlime> MAZE_SLIME = registerWithEgg("maze_slime", EntityType.Builder.of(MazeSlime::new, MobCategory.MONSTER).sized(0.52F, 0.52F).eyeHeight(0.325F).spawnDimensionsScale(4.0F).clientTrackingRange(10), MazeSlime::registerAttributes, MazeSlime::checkSlimeSpawnRules);
	...
	public static final EntityType<Penguin> PENGUIN = registerWithEgg("penguin", EntityType.Builder.of(Penguin::new, MobCategory.CREATURE).sized(0.5F, 0.9F).clientTrackingRange(8), Penguin::registerAttributes, Penguin::checkPenguinSpawnRules);
	...
	public static final EntityType<SwarmSpider> SWARM_SPIDER = registerWithEgg("swarm_spider", EntityType.Builder.of(SwarmSpider::new, MobCategory.MONSTER).sized(0.8F, 0.4F).clientTrackingRange(8), SwarmSpider::registerAttributes, SwarmSpider::checkSwarmSpawnRules);
	...
	public static final EntityType<WinterWolf> WINTER_WOLF = registerWithEgg("winter_wolf", EntityType.Builder.of(WinterWolf::new, MobCategory.MONSTER).sized(1.4F, 1.9F).eyeHeight(1.45F).clientTrackingRange(8), WinterWolf::registerAttributes, WinterWolf::checkWinterSpawnRules);
	public static final EntityType<Wraith> WRAITH = registerWithEgg("wraith", EntityType.Builder.of(Wraith::new, MobCategory.MONSTER).sized(0.6F, 2.1F).clientTrackingRange(8).fireImmune(), Wraith::registerAttributes, Wraith::checkWraithSpawnRules);
	public static final EntityType<Yeti> YETI = registerWithEgg("yeti", EntityType.Builder.of(Yeti::new, MobCategory.MONSTER).sized(1.4F, 2.4F).clientTrackingRange(8), Yeti::registerAttributes, Yeti::checkYetiSpawnRules);
	...
	public static <E extends Entity> EntityType<E> registerMisc(String name, EntityType.Builder<E> builder) {
		return register(name, builder.noLootTable().build(createIDFor(name)));
	}
	...
	public static <E extends LivingEntity> EntityType<E> registerWithPlacement(String name, EntityType.Builder<E> builder, Supplier<AttributeSupplier.Builder> attributes, @Nullable SpawnPlacements.SpawnPredicate<E> predicate) {
		EntityType<E> ret = register(name, builder.build(createIDFor(name)));
		ATTRIBUTES.put(ret, attributes);
		if (predicate != null) {
