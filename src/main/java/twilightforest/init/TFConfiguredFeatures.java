...
public final class TFConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		context.register(MUSHGLOOM_CLUSTER, new ConfiguredFeature<>(TFFeatures.RANDOM_PATCH, simplePatchConfiguration(new SimpleBlockConfiguration(BlockStateProvider.simple(TFBlocks.MUSHGLOOM)))));
