...
public class TFFeatures {
	...
	public static final DeferredHolder<Feature<?>, Feature<RandomPatchConfiguration>> RANDOM_PATCH = FEATURES.register("random_patch", () -> new RandomPatchFeature(RandomPatchConfiguration.CODEC));
