...
public final class TravellersModifierTypes {
	...
	private static <T extends TravellersModifier> MapCodec<T> register(String name, MapCodec<T> codec) {
		Registry.register(TFRegistries.TRAVELLERS_MODIFIER_TYPE, TwilightForestMod.prefix(name), codec);
		return codec;
	}
