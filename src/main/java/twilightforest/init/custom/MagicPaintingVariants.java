...
public class MagicPaintingVariants {
	...
	public static void bootstrap(BootstrapContext<MagicPaintingVariant> context) {
		register(context, DARKNESS, "Darkness", /* Name omitted by choice */ "???", 4, 2, TwilightForestMod.prefix("magic_paintings/back"), List.of(
		...
		register(context, LUCID_LANDS, "Lucid Lands", "Androsa", 3, 3, TwilightForestMod.prefix("magic_paintings/back"), List.of(
			new Layer("background", null, null, true, true),
		...
		register(context, THE_HOSTILE_PARADISE, "The Hostile Paradise", "Oz", 3, 2, TwilightForestMod.prefix("magic_paintings/back"), List.of(
		...
		register(context, CASTAWAY_PARADISE, "Castaway Paradise", "HexaBlu", 2, 4, TwilightForestMod.prefix("magic_paintings/back"), List.of(
		...
		register(context, MUSIC_IN_THE_MIRE, "Music in the Mire", "TripleHeadedSheep", 4, 3, TwilightForestMod.prefix("magic_paintings/back"), List.of(
