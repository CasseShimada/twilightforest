...
public class TFBiomes {
	...
	private static Biome applyGrassColorModifier(Biome biome, TFGrassColorModifier modifier) {
		if ((Object) biome instanceof TFGrassColorModifierHolder holder) {
			holder.twilightforest$setGrassColorModifier(modifier);
		}
		return biome;
	}
	...
	public static void bootstrap(BootstrapContext<Biome> context) {
		...
		context.register(OAK_SAVANNAH, biomeWithDefaults(defaultAmbientBuilder().snowGolemMelts(), defaultMobSpawning(), oakSavannaGen(featureGetter, carverGetter)).temperature(0.9F).downfall(0).build());
		...
		context.register(SPOOKY_FOREST, applyGrassColorModifier(biomeWithDefaults(defaultAmbientBuilder().closerWaterFog().grassColorOverride(0xC45123).foliageColorOverride(0xFF8501).fogColor(0x827391).waterColor(0xBC8857), spookSpawning(), spookyForestGen(featureGetter, carverGetter)).temperature(0.5F).downfall(1).build(), TFGrassColorModifier.SPOOKY_FOREST));
		context.register(ENCHANTED_FOREST, applyGrassColorModifier(biomeWithDefaults(fireflyParticles(defaultAmbientBuilder()).foliageColorOverride(0x00FFFF).grassColorOverride(0x00FFFF), defaultMobSpawning(), enchantedForestGen(featureGetter, carverGetter)).hasPrecipitation(false).build(), TFGrassColorModifier.ENCHANTED_FOREST));
		...
		context.register(SWAMP, applyGrassColorModifier(biomeWithDefaults(defaultAmbientBuilder().closerWaterFog().skyColor(0x002112).fogColor(0x003F21).grassColorOverride(0x5C694E).foliageColorOverride(0x496137).waterColor(0x95B55F), swampSpawning(), swampGen(featureGetter, carverGetter)).temperature(0.8F).downfall(0.9F).build(), TFGrassColorModifier.SWAMP));
		context.register(FIRE_SWAMP, biomeWithDefaults(whiteAshParticles(defaultAmbientBuilder().closerWaterFog().snowGolemMelts()).waterColor(0x2D0700).fogColor(0x380A00).grassColorOverride(0x572E23).foliageColorOverride(0x64260F).waterColor(0x6C2C2C), new MobSpawnSettings.Builder(), fireSwampGen(featureGetter, carverGetter)).hasPrecipitation(false).temperature(1).downfall(0.4F).build());

		context.register(DARK_FOREST, applyGrassColorModifier(biomeWithDefaults(defaultAmbientBuilder().skyColor(0x000000).fogColor(0x000000).grassColorOverride(0x4B6754).foliageColorOverride(0x3B5E3F), darkForestSpawning(), darkForestGen(featureGetter, carverGetter)).temperature(0.7F).downfall(0.8F).build(), TFGrassColorModifier.DARK_FOREST));
		context.register(DARK_FOREST_CENTER, applyGrassColorModifier(biomeWithDefaults(defaultAmbientBuilder().skyColor(0x000000).fogColor(0x493000).grassColorOverride(0x667540).foliageColorOverride(0xF9821E), new MobSpawnSettings.Builder(), darkForestCenterGen(featureGetter, carverGetter)).build(), TFGrassColorModifier.DARK_FOREST_CENTER));
