...
public class ScepterRepairRecipe extends CustomRecipe {
	...
	public static final MapCodec<ScepterRepairRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
		BuiltInRegistries.ITEM.byNameCodec().fieldOf("scepter").forGetter(ScepterRepairRecipe::getScepter),
		Ingredient.CODEC.listOf().fieldOf("repair_ingredients").forGetter(ScepterRepairRecipe::getRepairItems),
		Codec.INT.fieldOf("durability").forGetter(ScepterRepairRecipe::getRepairDurability)
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, ScepterRepairRecipe> STREAM_CODEC = StreamCodec.composite(
		ByteBufCodecs.registry(Registries.ITEM), ScepterRepairRecipe::getScepter,
		Ingredient.CONTENTS_STREAM_CODEC.apply(ByteBufCodecs.list()), ScepterRepairRecipe::getRepairItems,
		ByteBufCodecs.INT, ScepterRepairRecipe::getRepairDurability,
