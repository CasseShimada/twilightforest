...
public interface ConfigurableSpawns extends ControlledSpawns {
	...
	@Override
	default WeightedList<MobSpawnSettings.SpawnerData> getCombinedMonsterSpawnableList() {
		return this.getConfig().combinedMonsterSpawnableCache();
	}

	@Override
	default WeightedList<MobSpawnSettings.SpawnerData> getCombinedCreatureSpawnableList() {
