...
public class TreeConfigurations {
	...
	private static final BlockStateProvider BELOW_TRUNK = BlockStateProvider.simple(Blocks.DIRT);
	...
	public static final TreeConfiguration DARKWOOD_LANTERN_TREE = new TreeConfiguration.TreeConfigurationBuilder(
		...
		.decorators(ImmutableList.of(
			...
			new DangleFromTreeDecorator(
				...
				4,
				2,
				new WeightedStateProvider(createBlockList().add(Blocks.IRON_CHAIN.defaultBlockState(), 1)),
