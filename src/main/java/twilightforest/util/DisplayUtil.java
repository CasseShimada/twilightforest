...
public class DisplayUtil {
	...
	public boolean spawnBlockDisplay(Level level, BoundingBox box, BlockState displayState, float padding) {
		...
		Optional<Entity> spawned = EntityType.create(TagValueInput.create(ProblemReporter.DISCARDING, level.registryAccess(), entityNBT), level, new EntitySpawnRequest(EntitySpawnReason.MOB_SUMMONED, true));
