...
public final class EntityTypeTagGenerator extends FabricTagsProvider.EntityTypeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider registries) {
		...
		this.builder(EntityTypeTags.FALL_DAMAGE_IMMUNE)
			...
			.add(key(TFEntities.CARMINITE_GHASTLING))
			.add(key(TFEntities.KNIGHT_PHANTOM))
			.add(key(TFEntities.SNOW_QUEEN))
			.add(key(TFEntities.PENGUIN))
			.add(key(TFEntities.RAVEN))
			...
			.add(key(TFEntities.CARMINITE_GHASTGUARD))
			.add(key(TFEntities.TINY_BIRD));
		this.builder(EntityTypeTags.FREEZE_HURTS_EXTRA_TYPES).add(key(TFEntities.FIRE_BEETLE));
		this.builder(EntityTypeTags.FREEZE_IMMUNE_ENTITY_TYPES)
			...
			.add(key(TFEntities.WRAITH))
			.add(key(TFEntities.KNIGHT_PHANTOM))
			.add(key(TFEntities.WINTER_WOLF))
			.add(key(TFEntities.YETI))
			.addTag(TFEntityTypeTags.BOSSES);
		this.builder(EntityTypeTags.IMMUNE_TO_INFESTED).add(key(TFEntities.TOWERWOOD_BORER));
		this.builder(EntityTypeTags.IMMUNE_TO_OOZING).add(key(TFEntities.MAZE_SLIME));
		this.builder(EntityTypeTags.POWDER_SNOW_WALKABLE_MOBS)
			.add(key(TFEntities.PENGUIN))
			.add(key(TFEntities.STABLE_ICE_CORE))
			.add(key(TFEntities.UNSTABLE_ICE_CORE))
			.add(key(TFEntities.SNOW_GUARDIAN))
			...
			.add(key(TFEntities.RAVEN))
			.add(key(TFEntities.SQUIRREL))
			.add(key(TFEntities.DWARF_RABBIT))
			.add(key(TFEntities.TINY_BIRD))
			.add(key(TFEntities.KOBOLD))
			.add(key(TFEntities.DEATH_TOME))
			.add(key(TFEntities.MOSQUITO_SWARM))
			.add(key(TFEntities.TOWERWOOD_BORER));
