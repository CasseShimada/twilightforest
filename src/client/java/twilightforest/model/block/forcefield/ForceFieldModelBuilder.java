...
import twilightforest.client.model.generators.template.CustomLoaderBuilder;
...
public class ForceFieldModelBuilder extends CustomLoaderBuilder {
		...
		if (!this.elements.isEmpty()) {
			...
			this.elements.forEach(forceFieldElementBuilder -> {
				...
				for (Direction dir : Direction.values()) {
					...
					int rotation = switch (face.rotation()) {
						case R0 -> 0;
						case R90 -> 90;
						case R180 -> 180;
						case R270 -> 270;
	...
	public enum FaceRotation {
		...
		public Quadrant toQuadrant() {
			return switch (this) {
				case ZERO -> Quadrant.R0;
				case CLOCKWISE_90 -> Quadrant.R90;
				case UPSIDE_DOWN -> Quadrant.R180;
