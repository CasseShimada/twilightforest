...
public class GhastTrapParticle extends SingleQuadParticle {
	...
	public GhastTrapParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, SpriteSet sprites) {
		this(level, x, y, z, 3.0F, vx, vy, vz, sprites);
	}
	...
	public record Factory(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, net.minecraft.util.RandomSource random) {
			GhastTrapParticle particle = new GhastTrapParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprite);
