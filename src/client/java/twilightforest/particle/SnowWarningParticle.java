...
public class SnowWarningParticle extends SnowParticle {
	...
	SnowWarningParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, float scale, int lifetime, SpriteSet sprites) {
		super(level, x, y, z, vx, vy, vz, scale, sprites);
	...
	public record SimpleFactory(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, net.minecraft.util.RandomSource random) {
			SnowWarningParticle particle = new SnowWarningParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, 1, 50, this.sprite);
			return particle;
		}
	}
	...
	public record ExtendedFactory(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
		...
		@Override
		public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, net.minecraft.util.RandomSource random) {
			SnowWarningParticle particle = new SnowWarningParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, 1, 100, this.sprite);
			return particle;
		}
	}
}
