...
public class IceBeamParticle extends SingleQuadParticle {
	...
	public IceBeamParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, float scale, SpriteSet sprites) {
	...
	public record Factory(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, net.minecraft.util.RandomSource random) {
			IceBeamParticle particle = new IceBeamParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, 0.75F, this.sprite);
			return particle;
		}
	}
}
