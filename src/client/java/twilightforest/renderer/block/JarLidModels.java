...
public final class JarLidModels {
	...
	private static final List<LidResource> LIDS = List.of(
		...
		lid(TFBlocks.STRIPPED_MANGROVE_LOG.asItem(), "stripped_mangrove_log"),
		lid(TFBlocks.STRIPPED_CANOPY_LOG.asItem(), "stripped_canopy_log"),
		lid(TFBlocks.STRIPPED_DARK_LOG.asItem(), "stripped_dark_log"),
		lid(TFBlocks.STRIPPED_MINING_LOG.asItem(), "stripped_mining_log"),
		lid(TFBlocks.STRIPPED_SORTING_LOG.asItem(), "stripped_sorting_log"),
		lid(TFBlocks.STRIPPED_TIME_LOG.asItem(), "stripped_time_log"),
		lid(TFBlocks.STRIPPED_TRANSFORMATION_LOG.asItem(), "stripped_transformation_log"),
		lid(TFBlocks.STRIPPED_TWILIGHT_OAK_LOG.asItem(), "stripped_twilight_oak_log"),
